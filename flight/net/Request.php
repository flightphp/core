...
class Request
{
    ...
    public function init(array $properties = []): self
    {
		...
		// Check PUT, PATCH, DELETE for data
            ...
            $this->getUnSupportMethodBodyData();
        }
    ...
    /**
     * Get the body data for unsupport methods. (PUT, DELETE, PATCH)
     * @return void
     */
    protected function getUnSupportMethodBodyData() {
        $body = $this->getBody();
        // Check Content-Type for multipart/form-data
        $isMultipart = preg_match('/boundary=(.*)$/is', $this->type, $matches) === 1;
